...
namespace TackEngine.Android {
    public static class ExtensionMethods {
        ...
        public static OpenTK.Vector2 ToOpenTKVec2(this TackEngine.Core.Main.Vector2f vec) {
            return new OpenTK.Vector2(vec.X, vec.Y);
        }

        // from OpenTK Vector2 to TE Vector2f
        public static TackEngine.Core.Main.Vector2f ToTEVec2(this OpenTK.Vector2 vec) {
            return new TackEngine.Core.Main.Vector2f(vec.X, vec.Y);
        }

        public static OpenTK.Vector3 ToOpenTKVec3(this TackEngine.Core.Main.Vector3 vec) {
            return new OpenTK.Vector3(vec.X, vec.Y, vec.Z);
        }

        // from TE Vector4 to OpenTK Vector4
        public static OpenTK.Vector4 ToOpenTKVec4(this TackEngine.Core.Main.Vector4 vec) {
            return new OpenTK.Vector4(vec.X, vec.Y, vec.Z, vec.W);
        }

        // from OpenTK Vector4 to TE Vector4
        public static TackEngine.Core.Main.Vector4 ToTEVec4(this OpenTK.Vector4 vec) {
            return new TackEngine.Core.Main.Vector4(vec.X, vec.Y, vec.Z, vec.W);
        }

        public static OpenTK.Matrix2 ToOpenTKMat2(this TackEngine.Core.Main.Matrix2 mat) {
            return new OpenTK.Matrix2(mat.Row0.X, mat.Row0.Y, mat.Row1.X, mat.Row1.Y);
        }

        public static OpenTK.Matrix3 ToOpenTKMat3(this TackEngine.Core.Main.Matrix3 mat) {
        ...
        public static OpenTK.Matrix4 ToOpenTKMat4(this TackEngine.Core.Main.Matrix4 mat) {
            return new OpenTK.Matrix4(mat.Row0.ToOpenTKVec4(), mat.Row1.ToOpenTKVec4(), mat.Row2.ToOpenTKVec4(), mat.Row3.ToOpenTKVec4());
        }

        public static TackEngine.Core.Main.Matrix4 ToTEMat4(this OpenTK.Matrix4 mat) {
            return new TackEngine.Core.Main.Matrix4(mat.Row0.ToTEVec4(), mat.Row1.ToTEVec4(), mat.Row2.ToTEVec4(), mat.Row3.ToTEVec4());
        }

        public static OpenTK.Vector4 ToOpenTKVec4(this TackEngine.Core.Main.Colour4b col) {
